...
//    private static final String source = "Channelnewsasia.com";
    ...
    public String scrapeContent() {
        ...
        try {
            Document doc = Jsoup.connect(url3).maxBodySize(0).timeout(5000).get();
            ...
            if(contentClassMap.containsKey(source)){
                ...
                filterUnnecessaryWords(filterClassMap, filterTagMap, elements);
    ...
    private void filterUnnecessaryWords(HashMap<String, List<String>> filterClassMap, HashMap<String, List<String>> filterTagMap, Elements elements) {
