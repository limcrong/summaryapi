...
//            headlineList.forEach(headline -> {
            for(Headline headline : headlineList){
                if (supportedSources.contains(headline.getSource().getName())) {
                    log.info("<START> Article {} source {} is supported: {}",headlineList.indexOf(headline),headline.getSource().getName(),headline.getUrl());
...
//                            newsArticles.add(newsArticle);
                    ...
                    log.info("<START><STOP> Article {} source {} is not supported: {}",headlineList.indexOf(headline),headline.getSource().getName(),headline.getUrl());
                }
            };
        }
    }
